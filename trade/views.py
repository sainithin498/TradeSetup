...
def buystockOrder(request):
    ...
    print(eshwar_data)
    _token = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..FvBabDeDBSfaqdcoX4ykt23pH3XCZXaTsVwWHnnDE-4"
    _key = "ISORT89TOC-100"
    # _token, _key = getToken()
    eshwar_id = _key
    token = _token
