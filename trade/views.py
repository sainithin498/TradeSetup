...
def buystockOrder(request):
    ...
    print(eshwar_data)
    _token = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..X7_PymLCnKoinCG0R6LyPeNAT2UewE7kLBqsCoGUdIo"
    _key = "ISORT89TOC-100"
    # _token, _key = getToken()
    eshwar_id = _key
    token = _token
