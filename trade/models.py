...
class UpstoxTradeSymbol(models.Model):
    ...
    trading_symbol = models.CharField(db_index=True,max_length=50,blank=True, null=True)
    name = models.CharField(max_length=50,blank=True, null=True)
    lot_size = models.IntegerField(blank=True, null=True)
    asset_type = models.CharField(db_index=True, max_length=50, blank=True, null=True)
    asset_symbol = models.CharField(db_index=True, max_length=50, blank=True, null=True)
